...
export class Model<T extends HasId> {
  ...
  //getter function to run the on function from Eventing class
  get on() {
    return this.events.on;
  }

  //getter function to run the trigger function from Eventing class
  get trigger() {
    return this.events.trigger;
  }

  //getter function to run the get function from Attributes class
  get get() {
